...
CREATE TABLE favorite_foods (
  food_id INTEGER, --PRIMARY KEY (MAYBE)
  name TEXT NOT NULL,
...
SELECT a.name, f.name FROM animals as a INNER JOIN favorite_foods as f on a.favorite_food_id = f.food_id WHERE vegetarian = 1;
